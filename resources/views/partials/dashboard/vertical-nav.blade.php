<ul class="navbar-nav iq-main-menu"  id="sidebar">
    ...
    <li class="nav-item">
        <a class="nav-link" data-bs-toggle="collapse" href="#horizontal-menu" role="button" aria-expanded="false" aria-controls="horizontal-menu">
            ...
            <span class="item-name">Option 1</span>
            <i class="right-icon">
        ...
        <ul class="sub-nav collapse" id="horizontal-menu" data-bs-parent="#sidebar">
            <li class="nav-item ">
                <a class="nav-link {{activeRoute(route('menu-style.horizontal'))}}" href="{{route('menu-style.horizontal')}}">
                  ...
                  <i class="sidenav-mini-icon"> 1.1 </i>
                  <span class="item-name"> Option 1.1 </span>
                </a>
            </li>
            <li class=" nav-item ">
                <a class="nav-link {{activeRoute(route('menu-style.dualhorizontal'))}}" href="{{route('menu-style.dualhorizontal')}}">
                    ...
                    <i class="sidenav-mini-icon"> 1.2 </i>
                    <span class="item-name">Option 1.2</span>
                </a>
            </li>
            <li class=" nav-item ">
                <a class="nav-link {{activeRoute(route('menu-style.dualcompact'))}}" href="{{route('menu-style.dualcompact')}}">
                    ...
                    <i class="sidenav-mini-icon"> 1.3 </i>
                    <span class="item-name">Option 1.3</span>
                </a>
            </li>
            <li class="nav-item ">
                <a class="nav-link {{activeRoute(route('menu-style.boxed'))}}" href="{{route('menu-style.boxed')}}">
                    ...
                    <i class="sidenav-mini-icon"> 1.4 </i>
                    <span class="item-name">Option 1.4</span>
                </a>
            </li>
            <li class="nav-item ">
                <a class="nav-link {{activeRoute(route('menu-style.boxedfancy'))}}" href="{{route('menu-style.boxedfancy')}}">
                    ...
                    <i class="sidenav-mini-icon"> 1.5 </i>
                    <span class="item-name">Option 1.5</span>
                </a>
            </li>
        </ul>
    </li>
    ...
    <li class="nav-item static-item">
        <a class="nav-link static-item disabled" href="#" tabindex="-1">
            <span class="default-icon"> More Stuff</span>
            <span class="mini-icon">-</span>
        </a>
    </li>
    <li class="nav-item">
